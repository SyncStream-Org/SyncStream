...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-neutral-950 focus-visible:ring-neutral-950/50 focus-visible:ring-[3px] aria-invalid:ring-red-500/20 dark:aria-invalid:ring-red-500/40 aria-invalid:border-red-500 dark:focus-visible:border-neutral-300 dark:focus-visible:ring-neutral-300/50 dark:aria-invalid:ring-red-900/20 dark:dark:aria-invalid:ring-red-900/40 dark:aria-invalid:border-red-900",
  {
    variants: {
      variant: {
        default:
          'bg-gray-900 text-neutral-50 shadow-xs hover:bg-gray-900/90 dark:bg-gray-50 dark:text-neutral-900 dark:hover:bg-gray-50/90',
        destructive:
        ...
        outline:
          'border bg-white shadow-xs hover:bg-gray-100 hover:text-neutral-900 dark:bg-gray-200/30 dark:border-neutral-200 dark:hover:bg-gray-200/50 dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-neutral-50 dark:dark:bg-gray-800/30 dark:dark:border-neutral-800 dark:dark:hover:bg-gray-800/50',
        secondary:
          'bg-gray-100 text-neutral-900 shadow-xs hover:bg-gray-100/80 dark:bg-gray-800 dark:text-neutral-50 dark:hover:bg-gray-800/80',
        ghost:
          'hover:bg-gray-100 hover:text-neutral-900 dark:hover:bg-gray-100/50 dark:hover:bg-gray-800 dark:hover:text-neutral-50 dark:dark:hover:bg-gray-800/50',
